    ...
    <View className="flex-row gap-3 items-start ml-0.5">
      <View className="justify-center items-center flex-row flex-1">
        ...
        <View className="justify-center flex-1 ml-3 gap-y-1 mt-1">
          <Text className="text-black font-pextrabold text-2xl" numberOfLines={1}>
            {title}
          </Text>
          <Text className="text-xl text-black font-pregular " numberOfLines={1}>
            {creator}
          </Text>
        </View>
      </View>
        ...
        ListHeaderComponent={() => (
          <View className="my-6 px-4 space-y-6">
            <View className="justify-between items-start flex-row mb-6">
              <View>
                <Text className="font-psemibold text-sm text-black">Welcome Back And Be Inspired</Text>
                <Text className="text-2xl font-pregular text-black">Jevs</Text>
              </View>
            ...
            <View className="w-full flex-1 pt-5 pb-7">
              <Text className="text-black text-lg font-psemibold mb-3">Popular Apps</Text>
              <Trending
            ...
            <Text className="text-black text-lg font-psemibold mb-3">New Release App</Text>
          </View>
        )}
